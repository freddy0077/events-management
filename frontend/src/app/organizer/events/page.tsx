  ...
  return (
    <div className="space-y-6">
      ...
      {events.length > 0 && (
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">Event Management Tips</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 md:grid-cols-2">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900">Monitor Registrations</h4>
                  <p className="text-sm text-gray-600">
                    Keep track of participant registrations and manage capacity limits
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Delegate responsibilities by assigning coordinators and staff to your events
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900">QR Code Check-in</h4>
                  <p className="text-sm text-gray-600">
                    Use the QR scanner for efficient participant check-in during events
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Export attendance and registration data for analysis and record-keeping
                  </p>
                </div>
              </div>
            </div>
